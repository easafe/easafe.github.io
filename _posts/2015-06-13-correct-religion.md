...
Looking around the web, I found an [interesting article](http://www.gotquestions.org/correct-religion.html) in the amazing website [http://www.gotquestions.org](http://www.gotquestions.org). For those of you who don't know, GotQuestions.org is a Christian apologetics website, featuring thousands of answers, pulled from the bible, to polemic issues such as homosexuality, sin, life after death and so on. However, the article at hand is a much more fundamental issue- hence, it tries to answer its headline, aptly titled _With all of the different religions, how can I know which one is correct?_, with sheer "logic". The first paragraphs read:
...
I, for one, would require only evidence to accept any claims about religious or God. The folks at GotQuestions.org have a different opinion, though- but is their framework any good? From the get-go, the first point, logical consistency, makes an illogical (or at best, from ignorance) argument: in Buddhism, not all desires are inherently evil or should be abandoned, rather the goal is see them  for what they are- and then seek fulfillment in oneself, not in the external world. And I don't see how consistency alone will help us in choosing the right religion as [logically consistent premises](https://en.wikibooks.org/wiki/Introduction_to_Philosophical_Logic/Consistency_and_Inconsistency#Definition_of_Consistency) do not warrant [truthful conclusions](https://en.wikipedia.org/wiki/False_premise). As for the second point, empirical adequacy, I will have to agree: talk is cheap, where is the evidence? (well, there's also no proof for Jesus' miracles, let alone his divinity, but the author doesn't seem to be bothered by it) I also fail to see how the last point has any relevance. Who is to say the true religion is not amoral or has a God who doesn't care about us at all? Just because we would like something- or have a pre conceived notion to project- it does not mean reality must conform. In fact, it doesn't even mean it would- or else, I really would like to be able to breath in space, or take a vacation in Thailand.
...
The only answer I can give to any of these 10 questions is: why? Why would be any of these intrinsic to the question of actual religion? Suppose you were an Indian born in a remote island with no concept of religious belief. Now, being a rational person, and knowing nothing about Jesus, God, Buddha, or anything else, you decide to filter out which, if any, of all religious claims is true. I fancy you would follow the easiest step, pre stated above, and ask where the evidences are. But, say, you decide to go by elimination (like the article seems to conveniently do), wouldn't you have to include features from _all_ religious? Your list would surely have items such as:
...
Then why does the list from the article seems to beg the question? Why feature God and Jesus so prominently when we haven't even ruled out Evil (or any other force) as the truthful religion? Let's see what the author has for answers:
...
I should argue that absolute truth indeed does not exist; we have to assume the reality and that we can reason about it, bla bla bla. But let's take a pragmatic approach and agree with the article that, in a practical, day-to-day sense, absolute truths exists. However, which from any of the arguments above demonstrate that only one absolute, i.e. correct, religion exists? Hinduism has an interesting concept, [Trimurti](https://en.wikipedia.org/wiki/Trimurti), which says all their gods are different aspects of the same all pervasive God. As the reasoning of the articles goes, this could also very well be an absolute truth: [Svayam Bhagavan](https://en.wikipedia.org/wiki/Svayam_Bhagavan) is the only true God and all religions are just misleading facets of him- whether they agree with each other or not. Also what guarantee exists that God or Gods can reliably transmit their message? Couldn't all religions be the same core truths degenerated in different ways? Well, for what it is worth, most religious can be distilled to "treat others well and look for something higher than yourself".

And the last paragraph. Who is to say that agnosticism or skepticism- saying "it's not possible to know"- isn't the only attainable answer in the end? Not the arguments outlined there, for sure.
...
_The argument from God can be presented very simply: Something exists..._ hold on, is that the [cosmological argument](https://en.wikipedia.org/wiki/Cosmological_argument)? Indeed, very simply presented and not the least satisfactory. First of all, it presumes that _everything_ with a beginning has a cause, which is not necessarily true in the case of the universe: the big bang is the beginning of the universe _as we know it_; its mass, or energy, could have existed forever- even if questioning what happened _before_ time began makes not much sense, as the laws of nature themselves were created in the big bang. And then, if the universe actually had a cause (was created intentionally, or from nothing), what evidence is there that a "who" (a personal being) and not a "what" (some undisclosed event or impersonal being) caused it? What about _multiple_ Gods? And so, [turtles all the way down](https://en.wikipedia.org/wiki/Turtles_all_the_way_down), what caused the cause of the universe? Saying God is the uncaused cause doesn't cut it- it is just [special pleading](https://en.wikipedia.org/wiki/Special_pleading), since no evidence has been provided. Nevertheless, even without evidences, the article proceeds to demonstrate some characteristics of the being who created the universe:
