...
_The argument from God can be presented very simply: Something exists..._ hold on, is that the cosmological argument? Oh my, you can see the author thinks that cause = order of events since he brings up "beginning", "eternal" in the explanation of the universe... The actual argument advanced (which can't be poked holes by "then who created god" or some shit) is not "simple", and couldn't be properly explained in the sketchy way the article is hurried.
